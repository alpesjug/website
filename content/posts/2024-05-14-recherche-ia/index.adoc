...
description: "La recherche ne se contente plus de l'approche maintenant traditionnelle basée sur la fréquence des termes (TF/IDF ou BM25) mais plus sur la tendance actuelle du machine learning."
image: cover.jpg
tags: conference
date: 2024-05-14
---
...
== Le conférencier: David Pilato

David Pilato - Developer | Evangelist
Depuis 2013, David Pilato est développeur et évangéliste chez https://elastic.co[elastic.co], après avoir passé les deux années précédentes à promouvoir le projet open-source Elasticsearch. Il en anime la communauté française et organise des https://www.elastic.co/blog/free-lunch-for-open-source-engineers[BBLs] au sein des entreprises.
